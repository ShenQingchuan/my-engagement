...
.animal-icon {
    ...
    &--icon-wifi { background-image: url('../../assets/img/icons/wifi.svg'); }
    &--icon-location { background-image: url('../../assets/img/icons/location.svg'); }
    &--icon-page { background-image: url('../../assets/img/icons/page.svg'); }
}
